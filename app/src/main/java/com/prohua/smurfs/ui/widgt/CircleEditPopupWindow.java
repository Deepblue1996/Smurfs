...
public class CircleEditPopupWindow extends PopupWindow {
    private Context mContext;
    private float mShowAlpha = 0.66f;
    private Drawable mBackgroundDrawable;

    public CircleEditPopupWindow(Context context) {
    ...
    public void showAtLocation(View parent, int gravity, int x, int y) {
        ...
        // 获取焦点
        EditText editText = (EditText) getContentView().findViewById(R.id.t_edit);
