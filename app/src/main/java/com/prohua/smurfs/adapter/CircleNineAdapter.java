...
/**
 * CircleNineAdapter 校友圈九宫格适配器
 * Created by Deep on 2017/4/9 0009.
 */

public class CircleNineAdapter extends NineGridViewAdapter {
    private int statusHeight;

    public CircleNineAdapter(Context context, List<ImageInfo> imageInfo) {
