...
import static com.prohua.smurfs.base.GlobalConfig.USER_CIRCLE_DEL_ADDRESS;

/**
 * Created by Deep on 2017/4/25 0025.
 */

public class CircleDelNet {
    //持有接口变量
    private CallBackInterface mInterface;
    public static String msg;

    public CircleDelNet(CallBackInterface theInterface) {
        //这里是关键，把外部的接口实例引用到该类，给变量赋值
        mInterface = theInterface;
    }

    public void pullDown(String id) {
        ...
        Request request = new Request.Builder()
                .url(SEVER_ADDRESS + USER_CIRCLE_DEL_ADDRESS)
                .post(formBody)
                .build();
